...
export default function BemolarPage() {
  ...
  const openProfileModal = (patient: any) => {
    setSelectedPatient(patient);
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="1">Gulnora Abdullayeva - Ertalab smena</option>
                  <option value="2">Dilfuza Karimova - Kech smena</option>
                </select>
                <div className="absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none">
                  <i className="ri-arrow-down-s-line text-gray-400"></i>
                </div>
  ...
  const getModalTitle = () => {
    switch (modalType) {
      case 'tashxis': return 'Yangi tashxis qo\'shish';
      case 'muolaja': return 'Muolaja yozish';
      case 'xona': return 'Xona tanlash';
      case 'hamshira': return 'Hamshira biriktirish';
      case 'tahlil': return 'Tahlil natijasini yuklash';
      default: return '';
    }
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      <Header title="Bemorlar" subtitle="Bemorlar ro'yxati va ular bilan ishlash" />
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredPatients.map((patient) => (
                  <tr key={patient.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{patient.allergiyalar}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex space-x-1">
                        <button
                          onClick={() => openProfileModal(patient)}
                          className="w-8 h-8 flex items-center justify-center text-gray-600 hover:bg-gray-100 rounded-lg cursor-pointer whitespace-nowrap"
                          title="Ko'rish"
                        >
                        ...
                        <button
                          ...
                          className="w-8 h-8 flex items-center justify-center text-green-600 hover:bg-green-50 rounded-lg cursor-pointer whitespace-nowrap"
                        ...
                        <button
                          ...
                          className="w-8 h-8 flex items-center justify-center text-purple-600 hover:bg-purple-50 rounded-lg cursor-pointer whitespace-nowrap"
                        ...
                        <button
                          ...
                          className="w-8 h-8 flex items-center justify-center text-pink-600 hover:bg-pink-50 rounded-lg cursor-pointer whitespace-nowrap"
                        ...
                        <button
                          ...
                          className="w-8 h-8 flex items-center justify-center text-orange-600 hover:bg-orange-50 rounded-lg cursor-pointer whitespace-nowrap"
          ...
          <div className="space-y-6">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-semibold text-gray-900">
                    {selectedPatient.ism} {selectedPatient.familiya}
                  </h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-900">{selectedPatient.yosh} yosh</p>
              </div>
              <div>
