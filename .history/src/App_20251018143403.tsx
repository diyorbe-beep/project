      ...
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <a href="/admin" className="text-gray-700 hover:text-sky-900 transition-colors">Admin</a>
            <button
      ...
      <section id="services" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-xl transition-all transform hover:-translate-y-2">
              <div className="w-20 h-20 bg-sky-100 rounded-2xl flex items-center justify-center mb- multiEdit">
