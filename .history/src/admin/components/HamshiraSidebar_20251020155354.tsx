...
const hamshiraMenuItems = [
  { id: 'dashboard', label: 'Bosh sahifa', icon: LayoutDashboard, path: '/hamshira' },
  { id: 'bemorlar', label: 'Mening bemorlarim', icon: Users, path: '/hamshira/bemorlar' },
  { id: 'vitals', label: 'Hayotiy ko\'rsatkichlar', icon: Heart, path: '/hamshira/vitals' },
  { id: 'muolaja', label: 'Muolajalar', icon: Pill, path: '/hamshira/muolaja' },
  { id: 'tahlillar', label: 'Tahlil namunalari', icon: TestTube, path: '/hamshira/tahlillar' },
  { id: 'xonalar', label: 'Xonalar', icon: Bed, path: '/hamshira/xonalar' },
  { id: 'bildirishnomalar', label: 'Bildirishnomalar', icon: Bell, path: '/hamshira/bildirishnomalar' },
  { id: 'profil', label: 'Profil', icon: Settings, path: '/hamshira/profil' }
];
