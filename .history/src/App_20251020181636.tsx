...
import HamshiraDashboardPage from './admin/pages/hamshira-dashboard/page';

// Shifokor pages
import ShifokorBemorlarPage from './admin/pages/shifokor/bemorlar/page';
import ShifokorTashxisPage from './admin/pages/shifokor/tashxis/page';
import ShifokorMuolajaPage from './admin/pages/shifokor/muolaja/page';
import ShifokorTahlillarPage from './admin/pages/shifokor/tahlillar/page';
import ShifokorXonalarPage from './admin/pages/shifokor/xonalar/page';
import ShifokorHamshiralarPage from './admin/pages/shifokor/hamshiralar/page';
import ShifokorProfilPage from './admin/pages/shifokor/profil/page';

// Hamshira pages
import HamshiraBemorlarPage from './admin/pages/hamshira/bemorlar/page';
import HamshiraVitalsPage from './admin/pages/hamshira/vitals/page';
import HamshiraMuolajaPage from './admin/pages/hamshira/muolaja/page';
import HamshiraTahlillarPage from './admin/pages/hamshira/tahlillar/page';
import HamshiraXonalarPage from './admin/pages/hamshira/xonalar/page';
import HamshiraBildirishnomalarPage from './admin/pages/hamshira/bildirishnomalar/page';
import HamshiraProfilPage from './admin/pages/hamshira/profil/page';
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/admin/bemorlar" element={
            <ProtectedRoute allowedRoles={['admin', 'shifokor']}>
              <AdminLayout>
                <BemolarPage />
              </AdminLayout>
            </ProtectedRoute>
          ...
          <Route path="/admin/hamshira-dashboard" element={
            <ProtectedRoute allowedRoles={['admin']}>
              <AdminLayout>
                <HamshiraDashboardPage />
              </AdminLayout>
            </ProtectedRoute>
          } />
          ...
          <Route path="/shifokor/bemorlar" element={
            <ProtectedRoute allowedRoles={['shifokor']}>
              <ShifokorLayout>
                <ShifokorBemorlarPage />
              </ShifokorLayout>
            </ProtectedRoute>
          } />
          <Route path="/shifokor/tashxis" element={
            <ProtectedRoute allowedRoles={['shifokor']}>
              <ShifokorLayout>
                <ShifokorTashxisPage />
              </ShifokorLayout>
          ...
          <Route path="/shifokor/muolaja" element={
            <ProtectedRoute allowedRoles={['shifokor']}>
              <ShifokorLayout>
                <ShifokorMuolajaPage />
              </ShifokorLayout>
          ...
          <Route path="/shifokor/tahlillar" element={
            <ProtectedRoute allowedRoles={['shifokor']}>
              <ShifokorLayout>
                <ShifokorTahlillarPage />
              </ShifokorLayout>
            </ProtectedRoute>
          } />
          <Route path="/shifokor/xonalar" element={
            <ProtectedRoute allowedRoles={['shifokor']}>
              <ShifokorLayout>
                <ShifokorXonalarPage />
              </ShifokorLayout>
          ...
          <Route path="/shifokor/hamshiralar" element={
            <ProtectedRoute allowedRoles={['shifokor']}>
              <ShifokorLayout>
                <ShifokorHamshiralarPage />
              </ShifokorLayout>
            </ProtectedRoute>
          } />
          <Route path="/shifokor/profil" element={
            <ProtectedRoute allowedRoles={['shifokor']}>
              <ShifokorLayout>
                <ShifokorProfilPage />
              </ShifokorLayout>
          ...
          <Route path="/hamshira/bemorlar" element={
            <ProtectedRoute allowedRoles={['hamshira']}>
              <HamshiraLayout>
                <HamshiraBemorlarPage />
              </HamshiraLayout>
            </ProtectedRoute>
          } />
          <Route path="/hamshira/vitals" element={
            <ProtectedRoute allowedRoles={['hamshira']}>
              <HamshiraLayout>
                <HamshiraVitalsPage />
              </HamshiraLayout>
          ...
          <Route path="/hamshira/muolaja" element={
            <ProtectedRoute allowedRoles={['hamshira']}>
              <HamshiraLayout>
                <HamshiraMuolajaPage />
              </HamshiraLayout>
          ...
          <Route path="/hamshira/tahlillar" element={
            <ProtectedRoute allowedRoles={['hamshira']}>
              <HamshiraLayout>
                <HamshiraTahlillarPage />
              </HamshiraLayout>
            </ProtectedRoute>
          } />
          <Route path="/hamshira/xonalar" element={
            <ProtectedRoute allowedRoles={['hamshira']}>
              <HamshiraLayout>
                <HamshiraXonalarPage />
              </HamshiraLayout>
          ...
          <Route path="/hamshira/bildirishnomalar" element={
            <ProtectedRoute allowedRoles={['hamshira']}>
              <HamshiraLayout>
                <HamshiraBildirishnomalarPage />
              </HamshiraLayout>
            </ProtectedRoute>
          } />
          <Route path="/hamshira/profil" element={
            <ProtectedRoute allowedRoles={['hamshira']}>
              <HamshiraLayout>
                <HamshiraProfilPage />
              </HamshiraLayout>
          ...
          {/* Duxtir routes - redirected to shifokor */}
