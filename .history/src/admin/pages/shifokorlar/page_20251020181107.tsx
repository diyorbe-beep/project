                    ...
                    <td className="px-3 sm:px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-100 rounded-full flex items-center justify-center">
                          <i className="ri-user-heart-line text-blue-600 text-sm sm:text-base"></i>
                        </div>
                        <div className="ml-2 sm:ml-4">
                          <div className="text-xs sm:text-sm font-medium text-gray-900">{doctor.ism}</div>
                          <div className="text-xs sm:text-sm text-gray-500">{doctor.login}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-3 sm:px-6 py-4 whitespace-nowrap">
                      <div className="text-xs sm:text-sm text-gray-900">{doctor.mutaxassislik}</div>
                    </td>
                    <td className="px-3 sm:px-6 py-4 whitespace-nowrap">
                      <div className="text-xs sm:text-sm text-gray-900">{doctor.telefon}</div>
                      <div className="text-xs sm:text-sm text-gray-500">{doctor.email}</div>
                    </td>
                    <td className="px-3 sm:px-6 py-4 whitespace-nowrap">
                      <div className="text-xs sm:text-sm text-gray-900">{doctor.tajriba_yil} yil</div>
                    </td>
                    <td className="px-3 sm:px-6 py-4 whitespace-nowrap">
                      <button
                    ...
                    <td className="px-3 sm:px-6 py-4 whitespace-nowrap text-xs sm:text-sm font-medium">
                      <div className="flex space-x-1 sm:space-x-2">
                        <button
                          ...
                          className="w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center text-blue-600 hover:bg-blue-50 rounded-lg cursor-pointer"
                        >
                          <i className="ri-edit-line text-xs sm:text-sm"></i>
                        </button>
                        <button
                          onClick={() => handleDeleteDoctor(doctor.id)}
                          className="w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center text-red-600 hover:bg-red-50 rounded-lg cursor-pointer"
                        >
